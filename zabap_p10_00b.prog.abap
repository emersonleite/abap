...
START-OF-SELECTION.
  ...
  SELECT carrid connid fldate seatsmax seatsocc
     FROM sflight INTO gs_flight " TABLE gt_flight
        WHERE carrid = pa_cia
        AND connid IN so_con ORDER BY connid.
...
* write: /, 5
  ...
  LOOP AT gt_flight INTO gs_flight.
    ...
    HIDE: gs_flight-carrid.
  ENDLOOP.

AT LINE-SELECTION.

  SUBMIT zabap_p10_00
          WITH  carrid =  gs_flight-carrid AND RETURN VIA SELECTION-SCREEN.