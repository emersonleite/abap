...
DATA: gt_voo TYPE zty_meus_voos,
      ...
      as_livre TYPE sflight-seatsmax.
...
SELECT carrid connid fldate seatsmax seatsocc
  ...
  as_livre = gs_voo-seatsmax - gs_voo-seatsocc.

  WRITE:/ gs_voo-carrid, gs_voo-connid,gs_voo-fldate, gs_voo-seatsmax, gs_voo-seatsocc, as_livre.
